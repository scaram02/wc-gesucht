    ...
    return (
        <div className="about-page-container">
            ...
            <h1>About WC Gesucht</h1>
                ...
                <p>This was a simple app created for React practice and something to do. However, if you have feedback or questions or just want to chat further, you can find me at</p>
                <p>linke here to linkedin</p> 
                <p>or maybe my Github</p>
                <Link to='/'>Back</Link>
        </div>
        </div>
    )
